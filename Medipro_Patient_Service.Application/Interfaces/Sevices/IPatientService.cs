...
public interface IPatientService
{
    ...
    Task<Response<List<PatientDto?>>> GetAllPatients();

    public Task<Response<object>> GetPatient();
    public Task<Response<object>> MakeAppointment(AppointmentRequest appointmentRequest, string token);
}